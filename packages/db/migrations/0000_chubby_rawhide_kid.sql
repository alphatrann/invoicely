...
ALTER TABLE "invoice_metadata_payment_information" ADD CONSTRAINT "invoice_metadata_payment_information_invoice_metadata_id_invoice_metadata_id_fk" FOREIGN KEY ("invoice_metadata_id") REFERENCES "public"."invoice_metadata"("id") ON DELETE cascade ON UPDATE no action;